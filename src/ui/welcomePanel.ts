...
export class WelcomePanel {
  ...
  private buildHtml(): string {
    ...
    const features: Array<{ title: string; desc: string }> = [
      ...
      { title: "Local Database",            desc: "Resources are cached in a local SQLite database for quick access and offline viewing and dynamically refreshed when user refreshes" },
    ];
